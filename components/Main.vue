	...
	<div>
		<div class="flex flex-row bg-gray-900 h-full w-full justify-between items-center">
					...
					<div class="absolute bottom-10 left-10 right-10">
						<div class="flex justify-center">
							<button @click="firstShowPrev">
								<svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-gray-900 hover:text-visudo-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
			...
			<div class="w-1/2 h-5/6 mt-10 mb-10 ml-4 bg-gray-500 border rounded-lg border-gray-900 shadow-lg relative">
				...
				<div class="mt-8 mb-24 w-3/4 m-auto">
					<transition name="fade" mode="out-in">
						<div class="text-gray-900 text-center" v-if="!secondShow" key="0">
							I want to develop websites and web services for Streamers and Content Creators alike. The benefit of hiring me compared to going with a flat site generator is that you get a completely customized experience. I make dynamic sites that are tailored to your style and have custom features.
						</div>
						<div class="text-gray-900 text-center" v-else-if="secondShow" key="1">
